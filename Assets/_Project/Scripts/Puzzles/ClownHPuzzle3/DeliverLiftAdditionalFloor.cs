...
public class DeliverLiftAdditionalFloor : MonoBehaviour
{
    ...
    public bool IsAbleToMoveR;
    public bool IsCollidedWithCart;
    public bool IsCollidedWithCabinFloor;
    ...
    private void Update()
    {
        ...
        if(isHit && hit.collider.gameObject.CompareTag(TagManager.Lift) && !IsCollidedWithCabinFloor)
        {
            IsMovingL = true;
            IsAbleToMoveR = false;
        }
