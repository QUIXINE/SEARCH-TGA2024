...
public class CabinRotation : MonoBehaviour 
{
    ...
    {
        RaycastHit hit;
        if(Physics.Raycast(_raycastTransform.position, Vector3.left, out hit, _raycastDistance, _groundLayer) || Physics.Raycast(_raycastTransform.position, Vector3.right, out hit, _raycastDistance, _groundLayer))
        {
